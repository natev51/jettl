...
<Library LVVersion="21008000">
	...
	<Item Name="Event Loop.lvclass" Type="LVClass" URL="../Event Loop/Event Loop.lvclass"/>
	<Item Name="Event Loop Msg.lvclass" Type="LVClass" URL="../Event Loop Msg/Event Loop Msg.lvclass"/>
</Library>
